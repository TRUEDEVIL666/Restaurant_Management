...
import 'package:restaurant_management/layouts/home/combo_selection_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _closeTable(int tableNumber) async {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('Đã đóng bàn $tableNumber')));
  }
  ...
  void _showCloseTableDialog(BuildContext context, int tableNumber) {
    if (!(tableStatus[tableNumber] ?? false)) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Bàn $tableNumber chưa được mở!')));
      return;
    }
